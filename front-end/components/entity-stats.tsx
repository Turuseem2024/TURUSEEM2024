      ...
      {customCharts || (
        <>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <Card className="border border-gray-100 rounded-xl shadow-sm">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg font-medium">Rendimiento de {config.name}s</CardTitle>
          ...
          >
            <Card className="border border-gray-100 rounded-xl shadow-sm">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg font-medium">Actividad de {config.name}s</CardTitle>
